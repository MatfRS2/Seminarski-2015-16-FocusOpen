...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="body-area">
		<p>Hi,</p>
		<p>
			This is an automated email to inform you that an asset workflow has been cancelled.  This is usually due to a replacement
			asset being uploaded.  The asset details are below:
			<br />
			<br />
			Reference:
			...
			<br />
			<br />
			Please click on the link below to review asset details and publish it.
			<br />
